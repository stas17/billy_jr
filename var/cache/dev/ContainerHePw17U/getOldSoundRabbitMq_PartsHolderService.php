...
$f = ($this->services['old_sound_rabbit_mq.billi_event_producer'] ?? $this->load('getOldSoundRabbitMq_BilliEventProducerService.php'));
$g = ($this->services['old_sound_rabbit_mq.payment_consumer'] ?? $this->load('getOldSoundRabbitMq_PaymentConsumerService.php'));
$h = ($this->services['old_sound_rabbit_mq.payout_consumer'] ?? $this->load('getOldSoundRabbitMq_PayoutConsumerService.php'));
$i = ($this->services['old_sound_rabbit_mq.hold_consumer'] ?? $this->load('getOldSoundRabbitMq_HoldConsumerService.php'));
$j = ($this->services['old_sound_rabbit_mq.confirm_consumer'] ?? $this->load('getOldSoundRabbitMq_ConfirmConsumerService.php'));
$k = ($this->services['old_sound_rabbit_mq.unhold_consumer'] ?? $this->load('getOldSoundRabbitMq_UnholdConsumerService.php'));
...
$instance->addPart('old_sound_rabbit_mq.consumer', $g);
