...
$a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->load('getAnnotations_CachedReaderService.php')), array(0 => ($this->targetDirs[3].'/src/Entity'))), 'App\\Entity');
...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\BalanceRepository' => function () {
    return ($this->privates['App\Repository\BalanceRepository'] ?? $this->load('getBalanceRepositoryService.php'));
}, 'App\\Repository\\TestMigrateRepository' => function () {
    return ($this->privates['App\Repository\TestMigrateRepository'] ?? $this->load('getTestMigrateRepositoryService.php'));
