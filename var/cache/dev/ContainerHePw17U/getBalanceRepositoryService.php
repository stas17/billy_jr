...
// Returns the private 'App\Repository\BalanceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BalanceRepository.php';

return $this->privates['App\Repository\BalanceRepository'] = new \App\Repository\BalanceRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
