...
// Returns the public 'old_sound_rabbit_mq.payout_consumer' shared service.

include_once $this->targetDirs[3].'/vendor/php-amqplib/rabbitmq-bundle/RabbitMq/ConsumerInterface.php';
include_once $this->targetDirs[3].'/src/Consumer/PayoutConsumer.php';
...
$this->services['old_sound_rabbit_mq.payout_consumer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Consumer(($this->services['old_sound_rabbit_mq.connection.default'] ?? $this->load('getOldSoundRabbitMq_Connection_DefaultService.php')));

$instance->setExchangeOptions(array('name' => 'billy.v1.payout', 'type' => 'direct', 'passive' => false, 'durable' => true, 'auto_delete' => false, 'internal' => false, 'nowait' => false, 'declare' => true, 'arguments' => NULL, 'ticket' => NULL));
$instance->setQueueOptions(array('name' => 'billy.v1.payout', 'passive' => false, 'durable' => true, 'exclusive' => false, 'auto_delete' => false, 'nowait' => false, 'declare' => true, 'arguments' => NULL, 'ticket' => NULL, 'routing_keys' => array()));
$instance->setCallback(array(0 => new \App\Consumer\PayoutConsumer(($this->services['doctrine.orm.default_entity_manager'] ?? $this->load('getDoctrine_Orm_DefaultEntityManagerService.php')), ($this->privates['monolog.logger'] ?? $this->load('getMonolog_LoggerService.php')), ($this->privates['App\Services\EventService'] ?? $this->privates['App\Services\EventService'] = new \App\Services\EventService($this)), ($this->privates['App\Services\TransactionService'] ?? $this->load('getTransactionServiceService.php')), ($this->privates['App\Services\BalanceService'] ?? $this->load('getBalanceServiceService.php'))), 1 => 'execute'));
