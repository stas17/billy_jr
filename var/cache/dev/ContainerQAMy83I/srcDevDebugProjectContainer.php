...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'console.command.public_alias.App\\Command\\TestPaymentCommand' => 'getTestConsumerCommandService.php',
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'old_sound_rabbit_mq.base_amqp' => array(
                ...
                1 => 'old_sound_rabbit_mq.payment_consumer',
            ),
            'console.command.ids' => array(
                0 => 'console.command.public_alias.App\\Command\\TestPaymentCommand',
