...
// Returns the private 'App\Repository\TestMigrateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TestMigrateRepository.php';

return $this->privates['App\Repository\TestMigrateRepository'] = new \App\Repository\TestMigrateRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
