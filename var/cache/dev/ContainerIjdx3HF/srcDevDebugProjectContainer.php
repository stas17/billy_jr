...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'console.command.public_alias.App\\Command\\TestConfirmCommand' => 'getTestConfirmCommandService.php',
            'console.command.public_alias.App\\Command\\TestHoldCommand' => 'getTestHoldCommandService.php',
            'console.command.public_alias.App\\Command\\TestPaymentCommand' => 'getTestPaymentCommandService.php',
            'console.command.public_alias.App\\Command\\TestPayoutCommand' => 'getTestPayoutCommandService.php',
            'console.command.public_alias.App\\Command\\TestTransferCommand' => 'getTestTransferCommandService.php',
            'console.command.public_alias.App\\Command\\TestUnholdCommand' => 'getTestUnholdCommandService.php',
            ...
            'old_sound_rabbit_mq.billi_event_producer' => 'getOldSoundRabbitMq_BilliEventProducerService.php',
            'old_sound_rabbit_mq.confirm_consumer' => 'getOldSoundRabbitMq_ConfirmConsumerService.php',
            'old_sound_rabbit_mq.confirm_producer' => 'getOldSoundRabbitMq_ConfirmProducerService.php',
            'old_sound_rabbit_mq.connection.default' => 'getOldSoundRabbitMq_Connection_DefaultService.php',
            'old_sound_rabbit_mq.hold_consumer' => 'getOldSoundRabbitMq_HoldConsumerService.php',
            'old_sound_rabbit_mq.hold_producer' => 'getOldSoundRabbitMq_HoldProducerService.php',
            'old_sound_rabbit_mq.parts_holder' => 'getOldSoundRabbitMq_PartsHolderService.php',
            'old_sound_rabbit_mq.payment_consumer' => 'getOldSoundRabbitMq_PaymentConsumerService.php',
            'old_sound_rabbit_mq.payment_producer' => 'getOldSoundRabbitMq_PaymentProducerService.php',
            'old_sound_rabbit_mq.payout_consumer' => 'getOldSoundRabbitMq_PayoutConsumerService.php',
            'old_sound_rabbit_mq.payout_producer' => 'getOldSoundRabbitMq_PayoutProducerService.php',
            'old_sound_rabbit_mq.transfer_consumer' => 'getOldSoundRabbitMq_TransferConsumerService.php',
            'old_sound_rabbit_mq.transfer_producer' => 'getOldSoundRabbitMq_TransferProducerService.php',
            'old_sound_rabbit_mq.unhold_consumer' => 'getOldSoundRabbitMq_UnholdConsumerService.php',
            'old_sound_rabbit_mq.unhold_producer' => 'getOldSoundRabbitMq_UnholdProducerService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/monolog/monolog/src/Monolog/Handler/AbstractSyslogHandler.php';
            include_once $this->targetDirs[3].'/vendor/monolog/monolog/src/Monolog/Handler/SyslogHandler.php';
    ...
    protected function getDebug_DebugHandlersListenerService()
    {
        ...
        return $this->privates['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, $a, NULL, -1, true, new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL), true);
    }
    ...
    {
        $this->privates['monolog.handler.file_log'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/log/dev.log'), 100, true, NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'old_sound_rabbit_mq.base_amqp' => array(
                0 => 'old_sound_rabbit_mq.payment_producer',
                1 => 'old_sound_rabbit_mq.hold_producer',
                2 => 'old_sound_rabbit_mq.payout_producer',
                3 => 'old_sound_rabbit_mq.confirm_producer',
                4 => 'old_sound_rabbit_mq.unhold_producer',
                5 => 'old_sound_rabbit_mq.transfer_producer',
                6 => 'old_sound_rabbit_mq.billi_event_producer',
                7 => 'old_sound_rabbit_mq.payment_consumer',
                8 => 'old_sound_rabbit_mq.payout_consumer',
                9 => 'old_sound_rabbit_mq.hold_consumer',
                10 => 'old_sound_rabbit_mq.confirm_consumer',
                11 => 'old_sound_rabbit_mq.unhold_consumer',
                12 => 'old_sound_rabbit_mq.transfer_consumer',
            ),
            'console.command.ids' => array(
                0 => 'console.command.public_alias.App\\Command\\TestConfirmCommand',
                1 => 'console.command.public_alias.App\\Command\\TestHoldCommand',
                2 => 'console.command.public_alias.App\\Command\\TestPaymentCommand',
                3 => 'console.command.public_alias.App\\Command\\TestPayoutCommand',
                4 => 'console.command.public_alias.App\\Command\\TestTransferCommand',
                5 => 'console.command.public_alias.App\\Command\\TestUnholdCommand',
